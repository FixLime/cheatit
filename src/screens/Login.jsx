  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        backgroundImage: 'repeating-linear-gradient(135deg, transparent 0 60px, rgba(255,255,255,0.015) 60px 61px)',
      }}/>

      <div style={{
        position: 'relative', width: 420, padding: 40,
        background: '#1C1C1F', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 8,
      }}>
        ...
        <div style={{
          ...
          letterSpacing: '-0.01em', margin: '8px 0 24px', lineHeight: 1.05,
        }}>Sign in<br/>via Steam</div>
        <p style={{ color: '#C8C8CE', fontSize: 13, lineHeight: 1.5, marginBottom: 24, marginTop: 0 }}>
        ...
        <div style={{
          ...
          color: '#5A5A62', fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.12em',
        }}>
        ...
        <button
          ...
          style={{
            ...
            letterSpacing: '0.08em', cursor: 'pointer', transition: 'border-color 180ms',
          }}
